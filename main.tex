...
\begin{frame}[fragile]{ExaModels: the type \emph{is} the tree}
  ...
  \end{columns}
  \visible<2->{\smallskip
    \scriptsize\alert{ExaModels encodes the algebraic structure directly into the type system.} Just by looking at the type, you can read the structure of the expression --- and the Julia compiler dispatches statically all the way down.
  }
\end{frame}
