  ...
  \begin{columns}[c]
    ...
    \begin{column}{.40\textwidth}
      ...
      \begin{tikzpicture}[every node/.style={font=\scriptsize, align=center}]
        % --- Layout (LP/QP):
        %   CPU label at y=4.15; CPU image south at y=2.6 (top ~y=4.05)
        %   Bus band   y=1.30 to 1.70 (center 1.50)
        %   GPU image north at y=0.4 (bottom ~y=-0.73)
        %   GPU label  at y=-0.95
        % CPU image at top
        ...
        % Arrows: down on left (problem), up on right (solution)
        \draw[->, very thick, mitred] (-0.55, 2.55) -- (-0.55, 0.45);
        \draw[->, very thick, mitred] (0.55, 0.45) -- (0.55, 2.55);
        % Arrow labels in the gaps between bus and CPU/GPU images
  ...
  \begin{columns}[c]
    ...
    \begin{column}{.40\textwidth}
      ...
      \begin{tikzpicture}[every node/.style={font=\scriptsize, align=center}]
        ...
        % iter labels: row above bus band; white background occludes arrow shafts at label
