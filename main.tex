...
\lstdefinelanguage{juliarepl}{
  ...
  literate={julia>}{{{\color{omrPrompt}\bfseries julia>}}}{6}
           {0}{{{\color{omrNumber}0}}}{1}
           {1}{{{\color{omrNumber}1}}}{1}
           {2}{{{\color{omrNumber}2}}}{1}
           {3}{{{\color{omrNumber}3}}}{1}
           {4}{{{\color{omrNumber}4}}}{1}
           {5}{{{\color{omrNumber}5}}}{1}
           {6}{{{\color{omrNumber}6}}}{1}
           {7}{{{\color{omrNumber}7}}}{1}
           {8}{{{\color{omrNumber}8}}}{1}
           {9}{{{\color{omrNumber}9}}}{1}
           {+}{{{\color{omrOp}+}}}{1}
           {-}{{{\color{omrOp}-}}}{1}
           {*}{{{\color{omrOp}*}}}{1}
           {=}{{{\color{omrOp}=}}}{1},
