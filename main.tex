...
% Julia REPL palette (matches the OhMyREPL / default Julia colors):
%   julia>  -> bold green;    # comments -> grey;   numbers/units -> sky blue
\definecolor{replprompt}{HTML}{4DAD5E}
\definecolor{replcomment}{HTML}{8E9AA0}
\definecolor{repltime}{HTML}{4FA8DB}

\lstdefinelanguage{juliarepl}{
  morecomment=[l]{\#},
  morekeywords={ms,us,s,ns,Hz,kHz,GHz,GiB,MiB,KiB,GB,MB,kB},
  sensitive=true,
  literate={julia>}{{{\color{replprompt}\bfseries julia>}}}{6}
           {0}{{{\color{repltime}0}}}{1}
           {1}{{{\color{repltime}1}}}{1}
           {2}{{{\color{repltime}2}}}{1}
           {3}{{{\color{repltime}3}}}{1}
           {4}{{{\color{repltime}4}}}{1}
           {5}{{{\color{repltime}5}}}{1}
           {6}{{{\color{repltime}6}}}{1}
           {7}{{{\color{repltime}7}}}{1}
           {8}{{{\color{repltime}8}}}{1}
           {9}{{{\color{repltime}9}}}{1},
}

\lstdefinestyle{darkrepl}{
  language=juliarepl,
  basicstyle=\ttfamily\color{white}\scriptsize,
  commentstyle=\color{replcomment}\itshape,
  keywordstyle=\color{repltime}\bfseries,
  backgroundcolor=,
  frame=none,
  framesep=0pt,
  xleftmargin=0pt,
...
\begin{frame}[fragile]{Where the gap comes from: JuMP unrolls into a type-erased array}
  \begin{columns}[T]
    ...
    \begin{column}{.48\textwidth}
      ...
      \begin{tikzpicture}[every node/.style={font=\scriptsize, align=center},
        ...
        \node[font=\scriptsize\ttfamily, anchor=south] at (0, 2.2) {\texttt{f.args :: Vector\{Any\}}};
  ...
  \small
  \begin{itemize}\itemsep1pt
  \item JuMP \alert{unrolls the expression at construction} into a flat \texttt{Vector\{Any\}} --- structure lives only in the runtime element types
